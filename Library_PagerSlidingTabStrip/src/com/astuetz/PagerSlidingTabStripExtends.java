...
public class PagerSlidingTabStripExtends extends HorizontalScrollView {
	...
	public LazyViewPager.OnPageChangeListener delegatePageListener;
	...
	private int curViewPagerItem;                                        // 记录当前viewpager选中页面的索引
	/*--------------- add end ---------------*/
	...
	public PagerSlidingTabStripExtends(Context context, AttributeSet attrs, int defStyle) {
		...
		indicatorHeight =
				a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsIndicatorHeight, indicatorHeight);
		underlineHeight =
		...
		selectedTabTextSize =
				a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsSelectedTabTextSize, selectedTabTextSize);
		selectedTabTextColor =
				a.getColor(R.styleable.PagerSlidingTabStrip_pstsSelectedTabTextColor, selectedTabTextColor);
...
//	}
	public void setLazyViewPager(LazyViewPager pager) {
		this.pager = pager;
...
//		canvas.drawPath(path, rectPaint);
	...
	private class PageListener implements LazyViewPager.OnPageChangeListener {
