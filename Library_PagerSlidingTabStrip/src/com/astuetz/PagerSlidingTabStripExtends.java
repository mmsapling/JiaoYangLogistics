...
public class PagerSlidingTabStripExtends
        extends HorizontalScrollView
{
    ...
    public PagerSlidingTabStripExtends(Context context, AttributeSet attrs, int defStyle) {
		...
		/*--------------- add begin ---------------*/
        tabTextSize = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsTabTextSize,
                                              tabTextSize);
            ...
            implements ViewPager.OnPageChangeListener
    {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            scrollToChild(position,
                          (int) (positionOffset * tabsContainer.getChildAt(position)
                                                               .getWidth()));
