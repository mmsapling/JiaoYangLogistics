...
public class ChangeColorIconWithText extends View
{
	...
	private String mText     = UIUtils.getString(R.string.app_name);
	...
	public ChangeColorIconWithText(Context context, AttributeSet attrs, int defStyleAttr)
	{
		...
		for (int i = 0; i < n; i++) {
			...
			switch (attr) {
				case R.styleable.ChangeColorIconWithText_dicon:
					BitmapDrawable drawable = (BitmapDrawable) a.getDrawable(attr);
					mIconBitmap = drawable.getBitmap();
				break;
			case R.styleable.ChangeColorIconWithText_dcolor:
				mColor = a.getColor(attr, 0xFF45C01A);
				break;
			case R.styleable.ChangeColorIconWithText_dtext:
				mText = a.getString(attr);
				break;
			case R.styleable.ChangeColorIconWithText_dtextsize:
		...
		mTextPaint.setColor(Color.parseColor("#9f9f9f"));//ff555555
	...
	{
		//这里修改原文本
		mTextPaint.setColor(0xff9f9f9f);
